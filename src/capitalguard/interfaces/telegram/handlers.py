...
async def analytics_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_html(f"<b>{text}</b>")

def register_all_handlers(application: Application):
    """
    تسجيل جميع معالجات البوت مرة واحدة (يُستدعى من main.py).
    """
    # 1) الأوامر الأساسية
    ...
    # 2) محادثة إنشاء التوصية + أزرار التأكيد/الإلغاء
    ...
    # 3) إدارة التوصيات المفتوحة والإغلاق السهل
    ...
    # 4) استقبال سعر الخروج (أولوية أقل من المحادثات)
