# src/capitalguard/interfaces/telegram/management_handlers.py (v16.3 - FINAL & STABLE)
"""
...
and includes all previous bug fixes.
"""
...
# This is a helper function, it should NOT be decorated.
...
# This is a handler, it SHOULD be decorated.
@unit_of_work
...
async def navigate_open_recs_handler(update: Update, context: ContextTypes.DEFAULT_TYPE, db_session):
    ...
    # This now correctly fetches either Recommendations for Analysts or UserTrades for Traders
...
def register_management_handlers(application: Application):
    ...
    # Message handler for all replies, routed by the unified_reply_handler
