...
# src/capitalguard/interfaces/telegram/management_handlers.py (v30.13 - Full Restore + NameError Fix)
"""
...
from capitalguard.interfaces.telegram.helpers import get_service, parse_cq_parts, _get_attr # ✅ CRITICAL FIX
