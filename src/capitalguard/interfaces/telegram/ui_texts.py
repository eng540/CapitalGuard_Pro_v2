...
# Version: v13.0.0-HOTFIX (Restored Missing Function)
# ✅ THE FIX: 
#    1. Restored '_get_webapp_link' to global scope (Fixes NameError).
#    2. Ensured Live Price logic is robust.
#    3. Verified PnL calculation logic.
...
# --- Helpers ---
# ✅ RESTORED: This function was missing or undefined in previous version causing crash
...
def _build_header(rec: Recommendation, bot_username: str) -> str:
    try:
        ...
        # Uses the restored helper function
