# src/capitalguard/application/services/trade_service.py (v22.1 - FINAL & COMPLETE)
"""
...
# A special, reserved ID for the system user who "owns" forwarded recommendations
...
class TradeService:
    ...
    async def track_forwarded_trade(self, user_id: str, trade_data: Dict[str, Any], db_session: Session) -> Dict[str, Any]:
        try:
            ...
            log.info(f"✅ Added forwarded trade #{new_trade.id} for user {user_id} via shadow rec #{shadow_rec.id}")
