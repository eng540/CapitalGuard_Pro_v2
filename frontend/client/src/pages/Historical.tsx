...
export default function Historical() {
  ...
  const [batchId, setBatchId] = React.useState<number | null>(() => readBatchIdFromLocation(typeof window === "undefined" ? "" : window.location.search));
  const selectBatch = React.useCallback((id: number) => {
    setBatchId(id);
