...
export default function Recommendations() {
  ...
  const selectRecommendation = (publicRef: string) => {
    setSelectedRef(publicRef); setCloseIdempotencyKey(null); setPartialCloseIdempotencyKey(null); setBreakevenIdempotencyKey(null); setCancelIdempotencyKey(null); setPartialClosePercent(""); setCloseNotice(null);
  };
  const requestClose = () => {
