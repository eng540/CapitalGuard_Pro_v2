...
import { parseIntakeText, type IntakeMode } from "./Historical";
...
export default function SmartDropzone() {
  ...
  const historicalIntake = trpc.capitalguard.historicalIntake.useMutation({ onSuccess: result => setBatchNotice(`تم استقبال الدفعة ${result.batch.ref} (${result.batch.accepted_records} عناصر قابلة للمراجعة).`) });
