...
export default function TmaBridge() {
  ...
  return <div className="fixed left-3 z-50 rounded-full border border-cyan-300/15 bg-[#0c1728]/90 px-3 py-1.5 text-[10px] text-cyan-200 shadow-lg backdrop-blur" style={{ bottom: "calc(0.75rem + var(--tma-safe-bottom, 0px))" }}>{label}</div>;
}
